          ...
          <li key={req.text} className="flex items-center space-x-2">
            {req.met ? (
              ...
              <X
                size={16}
                className={
                  isShowErrors ? "text-destructive" : "text-muted-foreground/80"
                }
              />
            )}
            <span
              className={`text-xs ${req.met ? "text-emerald-600" : isShowErrors ? "text-destructive" : "text-muted-foreground/80"}`}
            >
              {req.text}
